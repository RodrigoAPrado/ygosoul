    ...
    public class OldDuelRunner
    {
        ...
        private static void HandleAnnounceCard(IntPtr pDuel)
        {
            ...
            do
            {
                ...
                else
                {
                    ...
                    foreach (var q in query) Console.WriteLine($"[{q.Item1}] => {q.Item2}");
                }
            } while (response.Length == 0);
        ...
        private static void HandlePlayerInputSelections(IntPtr pDuel)
        {
            ...
            do
            {
                Console.WriteLine("\n--- AWAITING PLAYER'S INPUT ---");
                Console.WriteLine(
                    "Input your selections. Enter=confirm all, Cancel=cancel operation if able, Clear=reset your inputs: ");
                var value = "";
                foreach (var id in responseIds) value += id + ",";
