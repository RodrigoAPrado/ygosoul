...
public class IdleCmdSpellOrTrapSet : IdleCmdChoiceCard, IIdleSpellOrTrapSet
{
    public Location Location { get; }

    public IdleCmdSpellOrTrapSet(PlayerIdleAction playerIdleAction, uint cardCode, byte player, OCG_CardLocation location,
