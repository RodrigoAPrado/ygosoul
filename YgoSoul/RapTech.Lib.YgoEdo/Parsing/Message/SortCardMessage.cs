...
{
    public class SortCardMessage : ISelectionOcgMessage, ISortCardMessage
    {
        ...
        public override string ToString()
        {
            ...
            sb.AppendLine(
                $"Player {Player}, reorder the cards inputing their index with commas like a,b,c, or \"Cancel\":");
