...
public enum DuelOptions : ulong
{
    ...
    RushDuel = (ThreeColumnsField | NoMainPhase2 | NoStandbyPhase | FirstTurnDraw | InvertedQuickPriority 
                | DrawUntil5 | NoHandLimit | UnlimitedSummons | TrapMonstersNotUseZone | TriggerOnlyInLocation | ExtraDeckRitual),
    
    MasterRule1 = (OcgObsoleteIgnition | FirstTurnDraw | OneFaceUpField | SpSummonOnceOldNegate | ReturnToDeckTriggers | CannotSummonOathOld),
    
    MasterRuleGoat = (MasterRule1 | TcgFastEffectIgnition | UseTrapsInNewChain | SixStepBattleStep | TriggerWhenPrivateKnowledge 
                      | EquipNotSentIfMissingTarget | ZeroAtkDestroyed | StoreAttackReplays | SingleChainInDamageSubstep 
                      | CanReposIfNonSumplayer | TcgSegocNonPublic | TcgSegocFirstTrigger),
    
    MasterRule2 = (FirstTurnDraw | OneFaceUpField | SpSummonOnceOldNegate | ReturnToDeckTriggers | CannotSummonOathOld),
